...
class myPDF extends FPDF{
  function header()
  {
    ...
    $this->Cell(190,10,'LAPORAN DATA TRANSAKSI PERPUSTAKAAN',0,0,'C');
    $this->Ln(20);
  ...
  function headertable()
  {
    ...
    $this->Cell(25,8,'JUDUL BUKU',1,0,'C');
    $this->Cell(20,8,'NIS',1,0,'C');
    $this->Cell(35,8,'NAMA PEMINJAM',1,0,'C');
    $this->Cell(30,8,'TANGGAL PINJAM',1,0,'C');
    $this->Cell(30,8,'TANGGAL KEMBALI',1,0,'C');
  ...
  function data()
  {
    ...
    while ($row = mysqli_fetch_assoc($sql)) {
      ...
      $this->Cell(25,8,$row['judul'],1,0,'C');
      $this->Cell(20,8,$row['nim'],1,0,'C');
      $this->Cell(35,8,$row['nama'],1,0,'C');
      $this->Cell(30,8,$row['tgl_pinjam'],1,0,'C');
      $this->Cell(30,8,$row['tgl_kembali'],1,0,'C');
      $this->Cell(25,8,$row['status'],1,0,'C');
      $this->Cell(25,8,$row['ket'],1,0,'C');
      $this->Ln();
