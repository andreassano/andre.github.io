...
class buku extends perpus{	
	...
	public function create($judul,$pengarang,$penerbit,$thn_terbit,$isbn,$jumlah_buku,$lokasi,$waktu,$bukupic){
		try {
		$stmt = $this->conn->prepare('INSERT INTO tbl_buku(judul,pengarang,penerbit,thn_terbit,isbn,jumlah_buku,lokasi,tgl_input,foto) VALUES(?,?,?,?,?,?,?,?,?)');
	...
	public function update($id,$judul,$pengarang,$penerbit,$thn_terbit,$isbn,$jumlah_buku,$lokasi,$foto){
		try {
			if (empty($foto)) {
		  $stmt = $this->conn->prepare("UPDATE tbl_buku SET judul=:judul, pengarang=:pengarang, penerbit=:penerbit, thn_terbit=:thn_terbit, isbn=:isbn, jumlah_buku=:jumlah_buku, lokasi=:lokasi WHERE id=:id ");
				  ...
				  $stmt = $this->conn->prepare("UPDATE tbl_buku SET judul=:judul, pengarang=:pengarang, penerbit=:penerbit, thn_terbit=:thn_terbit, isbn=:isbn, jumlah_buku=:jumlah_buku, lokasi=:lokasi, foto=:foto WHERE id=:id ");
